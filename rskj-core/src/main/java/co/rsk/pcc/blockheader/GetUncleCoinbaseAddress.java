 ...
 * @author Diego Masini
 */
public class GetUncleCoinbaseAddress extends NativeMethod {
    ...
    public Object execute(Object[] arguments) {
        ...
        int uncleIndex = ((BigInteger) arguments[1]).intValue();
